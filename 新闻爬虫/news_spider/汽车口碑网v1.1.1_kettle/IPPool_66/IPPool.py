...
class IPPool():
    ...
    default_url = 'http://www.66ip.cn/nmtq.php?getnum=300&isp=0&anonymoustype=0&start=&ports=&export=&ipaddress=&area=1&proxytype=2&api=66ip'
    ...
    def get_ip(self):
        ...
        if self.url != IPPool.default_url:
            ...
            with open(self.file_path, 'r') as f:
                ...
                ip = random.choice(ips_list).strip()
                return {'http':'http://%s' % ip}#, 'https':'https://%s' % ip}
